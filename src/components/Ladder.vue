...
export default {
  ...
  data () {
    return {
      ...
      driverRanks: [
            { rank: 1, name: 'Jacob Abel', series: 'IndyNXT', wins: 1, titles: 'None', previous: '↑ 1'},
            { rank: 2, name: 'Louis Foster', series: 'IndyNXT', wins: 1, titles: 'None', previous: '↑ 1'},
            { rank: 3, name: 'Nolan Siegel', series: 'IndyNXT', wins: 0, titles: 'None', previous: '↓ 2'},
            ...
            { rank: 7, name: 'Hunter Yeany', series: 'USF Pro 2000', wins: 0, titles: 'None', previous: '-'},
