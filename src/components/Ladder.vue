  ...
  data () {
    return {
      ...
      driverRanks: [
            ...
            { rank: 12, name: 'Jace Denmark',series: 'USF Pro 2000', wins: 0, titles: 'USF2000', previous: 'Unranked'},
            ...
            { rank: 15, name: 'Ariel Elkin', series: 'USF Juniors', wins: 3, titles: 'None', previous: 'Unranked'},
