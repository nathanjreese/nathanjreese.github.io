  ...
  components: {
    ...
    data () {
      ...
      driverBios: [
      {
        ...
        //   "Indy500s": "0",
        //   "Color": "orange",
        //   "Summary": "In his first year with RLL, the team struggled out of the gate. Looking to shake things up, Harvey will move from the #45 to the #30 car within the same team this season. As one of the most likable drivers in the series, a lot of fans are hoping to see a turnaround for Harvey in 2023.",
