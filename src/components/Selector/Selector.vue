    ...
    data () {
      ...
      driverBios: [
      {
        ...
        },
        {
          ...
          "Indy500s": "0",
          "Color": "orange",
          "Summary": "The young Dutchman has an aggressive style on track and unique personality off track that makes him easy to root for. After spending the first 5 years of his career with Ed Carpenter Racing, Veekay moves over to Daly Coyne Racing in 2025. After a year of musical chairs in their cars in 2024, DCR hopes Veekay can provide them a little bit of stability this season, especially at the Indy 500 where Veekay has been one of the best qualifiers on the grid since coming into the series.",
        ...
        },
        {
          ...
          "Indy500s": "0",
          "Color": "red",
          "Summary": "Jacob Abel joins Dale Coyne Racing for his rookie season in IndyCar. The 2024 IndyNXT runner-up won 3 races but couldn't hold off a dominant Louis Foster, who he will continue his rivalry with in IndyCar as they both battle for rookie of the year. The Louisville, Kentucky native showed a lot of promise scoring 10 podiums last season in IndyNXT but might be in for a challenging rookie season with the underdog Dale Coyne Racing. A good season for Abel will include consistent clean runs with some top 10-15 finishes that he can build on for the future.",
          "picnum": new URL('@/assets/Numbers/51Number.png', import.meta.url),
