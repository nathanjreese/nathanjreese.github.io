  ...
  data () {
    return {
      ...
      items: [
        ...
        {id: '75', name: "Mick Schumacher", team: 'rahal', statusmobile: 'Fulltime', status: 'Fulltime - Did not race IndyCar in 2024', color: '#009fdf', color2: "black", wins: 0, podiums: 0, champs: 0, poles: 0, pic: new URL('@/assets/TeamDrivers/MickSchumacher.png', import.meta.url), flag: new URL('@/assets/Flags/UnitedStates.png', import.meta.url)},
        ...
        {id: '30', name: "Takuma Sato   *", team: 'rahal', statusmobile: 'Indy', status: 'Indy Only - 17th Indy 500 Start', color: '#007b84', color2: "black", wins: 6, podiums: 14, champs: 0, poles: 10, pic: new URL('@/assets/TeamDrivers/TakumaSato.png', import.meta.url), flag: new URL('@/assets/Flags/Japan.png', import.meta.url)},
