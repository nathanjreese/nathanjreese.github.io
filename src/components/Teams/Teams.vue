  ...
  data () {
    return {
      ...
      items: [
        ...
        {id: '47', name: "Mick Schumacher", team: 'rahal', statusmobile: 'Fulltime', status: 'Fulltime - Did not race IndyCar in 2024', color: '#009fdf', color2: "black", wins: 0, podiums: 0, champs: 0, poles: 0, pic: new URL('@/assets/TeamDrivers/MickSchumacher.png', import.meta.url), flag: new URL('@/assets/Flags/UnitedStates.png', import.meta.url)},
        ...
        {id: '19', name: "TBD", team: 'coyne', statusmobile: 'Fulltime', status: 'Fulltime - IndyNXT runner-up in 2024', color: '#cf171f', color2: "black", wins: 0, podiums: 0, champs: 0, poles: 0, pic: new URL('@/assets/TeamDrivers/tbd.png', import.meta.url), flag: new URL('@/assets/Flags/Norway.png', import.meta.url)},
