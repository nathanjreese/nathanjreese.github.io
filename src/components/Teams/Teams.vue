  ...
  data () {
    return {
      ...
      items: [
        ...
        {id: '26', name: "Will Power", team: 'andretti', statusmobile: 'Fulltime', status: 'Fulltime - 16th year with Penske', color: '#ffe303', color2: "whitesmoke", wins: 44, podiums: 105, champs: 2, poles: 70, pic: new URL('@/assets/TeamDrivers/WillPower.png', import.meta.url), flag: new URL('@/assets/Flags/Australia.png', import.meta.url)},
        ...
        {id: '76', name: "Rinus Veekay", team: 'juncos', statusmobile: 'Fulltime', status: 'Fulltime - Raced for ECR in 2024', color: '#02ff4f', color2: "black", wins: 1, podiums: 4, champs: 0, poles: 2, pic: new URL('@/assets/TeamDrivers/RinusVeekay.png', import.meta.url), flag: new URL('@/assets/Flags/Netherlands.png', import.meta.url)},
        ...
        {id: '12', name: "David Malukas", team: 'penske', statusmobile: 'Fulltime', status: 'Fulltime - Finished 2024 with MSR', color: '#ffe303', color2: "black", wins: 0, podiums: 2, champs: 0, poles: 0, pic: new URL('@/assets/TeamDrivers/DavidMalukas.png', import.meta.url), flag: new URL('@/assets/Flags/UnitedStates.png', import.meta.url)},
