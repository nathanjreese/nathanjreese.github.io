...
export default {
  ...
  data () {
    return {
      ...
      currentTeam: {},
      items: [
        {id: '10', name: "Alex Palou", team: 'ganassi', statusmobile: 'Fulltime', status: 'Fulltime - 5th year with CGR', color: '#ffcb01', color2: "#dc1433", wins: 19, podiums: 44, champs: 4, poles: 12, pic: new URL('@/assets/TeamDrivers/AlexPalou.png', import.meta.url), flag: new URL('@/assets/Flags/Spain.png', import.meta.url)},
        {id: '9', name: "Scott Dixon", team: 'ganassi', statusmobile: 'Fulltime', status: 'Fulltime - 24th year with CGR', color: '#084c8d', color2: "#fc7406", wins: 59, podiums: 145, champs: 6, poles: 32, pic: new URL('@/assets/TeamDrivers/ScottDixon.png', import.meta.url), flag: new URL('@/assets/Flags/NewZealand.png', import.meta.url)},
        {id: '2', name: "Josef Newgarden", team: 'penske', statusmobile: 'Fulltime', status: 'Fulltime - 9th year with Penske', color: '#b20010', color2: "whitesmoke", wins: 32, podiums: 61, champs: 2, poles: 20, pic: new URL('@/assets/TeamDrivers/JosefNewgarden.png', import.meta.url), flag: new URL('@/assets/Flags/UnitedStates.png', import.meta.url)},
        {id: '5', name: "Pato O'Ward", team: 'mclaren', statusmobile: 'Fulltime', status: 'Fulltime - 6th year with McLaren', color: '#F57634', color2: "black", wins: 9, podiums: 32, champs: 0, poles: 7, pic: new URL('@/assets/TeamDrivers/PatoOward.png', import.meta.url), flag: new URL('@/assets/Flags/Mexico.png', import.meta.url)},
        {id: '3', name: "Scott McLaughlin", team: 'penske', statusmobile: 'Fulltime', status: 'Fulltime - 5th year with Penske', color: '#f5af05', color2: "black", wins: 7, podiums: 23, champs: 0, poles: 10, pic: new URL('@/assets/TeamDrivers/ScottMcLaughlin.png', import.meta.url), flag: new URL('@/assets/Flags/NewZealand.png', import.meta.url)},
        {id: '26', name: "Will Power", team: 'andretti', statusmobile: 'Fulltime', status: 'Fulltime - 16th year with Penske', color: '#ffe303', color2: "whitesmoke", wins: 45, podiums: 108, champs: 2, poles: 70, pic: new URL('@/assets/TeamDrivers/WillPower.png', import.meta.url), flag: new URL('@/assets/Flags/Australia.png', import.meta.url)},
        {id: '26', name: "Colton Herta", team: 'none', statusmobile: 'Fulltime', status: 'Fulltime - 6th year with Andretti', color: '#ffe303', color2: "black", wins: 9, podiums: 18, champs: 0, poles: 14, pic: new URL('@/assets/TeamDrivers/ColtonHerta.png', import.meta.url), flag: new URL('@/assets/Flags/UnitedStates.png', import.meta.url)},
        {id: '7', name: "Christian Lundgaard", team: 'mclaren', statusmobile: 'Fulltime', status: 'Fulltime - Raced for RLL in 2024', color: '#F57634', color2: "black", wins: 1, podiums: 9, champs: 0, poles: 3, pic: new URL('@/assets/TeamDrivers/ChristianLundgaard.png', import.meta.url), flag: new URL('@/assets/Flags/Denmark.png', import.meta.url)},
        {id: '27', name: "Kyle Kirkwood", team: 'andretti', statusmobile: 'Fulltime', status: 'Fulltime - 3rd year with Andretti', color: '#ec2424', color2: 'whitesmoke', wins: 2, podiums: 6, champs: 0, poles: 3, pic: new URL('@/assets/TeamDrivers/KyleKirkwood.png', import.meta.url), flag: new URL('@/assets/Flags/UnitedStates.png', import.meta.url)},
        ...
        {id: '76', name: "Rinus Veekay", team: 'juncos', statusmobile: 'Fulltime', status: 'Fulltime - Raced for ECR in 2024', color: '#02ff4f', color2: "black", wins: 1, podiums: 5, champs: 0, poles: 2, pic: new URL('@/assets/TeamDrivers/RinusVeekay.png', import.meta.url), flag: new URL('@/assets/Flags/Netherlands.png', import.meta.url)},
        ...
        {id: '14', name: "Caio Collet", team: 'foyt', statusmobile: 'Fulltime', status: 'Rookie', color: '#fe0100', color2: "black", wins: 0, podiums: 0, champs: 0, poles: 0, pic: new URL('@/assets/TeamDrivers/CaioCollet.png', import.meta.url), flag: new URL('@/assets/Flags/Brazil.png', import.meta.url)},
        {id: '12', name: "David Malukas", team: 'penske', statusmobile: 'Fulltime', status: 'Fulltime - Finished 2024 with MSR', color: '#ffe303', color2: "black", wins: 0, podiums: 1, champs: 0, poles: 0, pic: new URL('@/assets/TeamDrivers/DavidMalukas.png', import.meta.url), flag: new URL('@/assets/Flags/UnitedStates.png', import.meta.url)},
        {id: '66', name: "Felix Rosenqvist", team: 'msr', statusmobile: 'Fulltime', status: 'Fulltime - 2nd year with MSR', color: '#0000eb', color2: "black", wins: 1, podiums: 7, champs: 0, poles: 6, pic: new URL('@/assets/TeamDrivers/FelixRosenqvist.png', import.meta.url), flag: new URL('@/assets/Flags/Sweden.png', import.meta.url)},
        ...
        {id: '60', name: "Marcus Armstrong", team: 'msr', statusmobile: 'Fulltime', status: 'Fulltime - Raced for CGR 2024', color: '#0000eb', color2: "black", wins: 0, podiums: 2, champs: 0, poles: 0, pic: new URL('@/assets/TeamDrivers/MarcusArmstrong.png', import.meta.url), flag: new URL('@/assets/Flags/NewZealand.png', import.meta.url)},
        {id: '76', name: "Conor Daly", team: 'drr', statusmobile: 'Fulltime', status: 'Fulltime - Joined Juncos midseason in 2024', color: '#02ff4f', color2: "black", wins: 0, podiums: 2, champs: 0, poles: 1, pic: new URL('@/assets/TeamDrivers/ConorDaly.png', import.meta.url), flag: new URL('@/assets/Flags/UnitedStates.png', import.meta.url)},
        ...
        {id: '45', name: "Louis Foster", team: 'rahal', statusmobile: 'Fulltime', status: 'Fulltime - IndyNXT champion in 2024', color: '#ec232c', color2: "black", wins: 0, podiums: 0, champs: 0, poles: 1, pic: new URL('@/assets/TeamDrivers/LouisFoster.png', import.meta.url), flag: new URL('@/assets/Flags/UnitedKingdom.png', import.meta.url)},
        ...
        {id: '21', name: "Christian Rasmussen", team: 'ecr', statusmobile: 'Fulltime', status: 'Fulltime - 2nd year with ECR', color: '#fbe44c', color2: "black", wins: 1, podiums: 2, champs: 0, poles: 0, pic: new URL('@/assets/TeamDrivers/ChristianRasmussen.png', import.meta.url), flag: new URL('@/assets/Flags/Denmark.png', import.meta.url)},
        {id: '47', name: "Mick Schumacher", team: 'rahal', statusmobile: 'Fulltime', status: 'Fulltime - Did not race IndyCar in 2024', color: '#009fdf', color2: "black", wins: 0, podiums: 0, champs: 0, poles: 0, pic: new URL('@/assets/TeamDrivers/MickSchumacher.png', import.meta.url), flag: new URL('@/assets/Flags/Germany.png', import.meta.url)},
        {id: '18', name: "Dennis Hauger", team: 'coyne', statusmobile: 'Fulltime', status: 'Fulltime - IndyNXT runner-up in 2024', color: '#cf171f', color2: "black", wins: 0, podiums: 0, champs: 0, poles: 0, pic: new URL('@/assets/TeamDrivers/DennisHauger.png', import.meta.url), flag: new URL('@/assets/Flags/Norway.png', import.meta.url)},
        ...
        {id: '83', name: "Robert Shwartzman", team: 'prema', statusmobile: 'Fulltime', status: 'Fulltime - Ferrari F1 reserve driver in 2024', color: '#ef0000', color2: "black", wins: 0, podiums: 0, champs: 0, poles: 1, pic: new URL('@/assets/TeamDrivers/RobertShwartzman.png', import.meta.url), flag: new URL('@/assets/Flags/Israel.png', import.meta.url)},
        {id: '98', name: "Marco Andretti   *", team: 'na', statusmobile: 'Indy', status: 'Indy Only - 20th Indy 500 Start', color: '#0c7cc4', color2: "whitesmoke", wins: 2, podiums: 20, champs: 0, poles: 6, pic: new URL('@/assets/TeamDrivers/MarcoAndretti.png', import.meta.url), flag: new URL('@/assets/Flags/UnitedStates.png', import.meta.url)},
        {id: '06', name: "Helio Castroneves   *", team: 'msr', statusmobile: 'Indy', status: 'Indy Only - 25th Indy 500 Start', color: '#155196', color2: "black", wins: 31, podiums: 94, champs: 0, poles: 50, pic: new URL('@/assets/TeamDrivers/HelioCastroneves.png', import.meta.url), flag: new URL('@/assets/Flags/Brazil.png', import.meta.url)},
        {id: '23', name: "Ryan Hunter-Reay   *", team: 'mclaren', statusmobile: 'Indy', status: 'Indy Only - 17th Indy 500 Start', color: '#00235d', color2: "black", wins: 18, podiums: 47, champs: 1, poles: 7, pic: new URL('@/assets/TeamDrivers/RyanHunterReay.png', import.meta.url), flag: new URL('@/assets/Flags/UnitedStates.png', import.meta.url)},
        ...
        {id: '75', name: "Takuma Sato   *", team: 'rahal', statusmobile: 'Indy', status: 'Indy Only - 17th Indy 500 Start', color: '#007b84', color2: "black", wins: 6, podiums: 14, champs: 0, poles: 10, pic: new URL('@/assets/TeamDrivers/TakumaSato.png', import.meta.url), flag: new URL('@/assets/Flags/Japan.png', import.meta.url)},
        {id: '134', name: "Katherine Legge   *", team: 'fa', statusmobile: 'Indy', status: 'Indy Only - 5th Indy 500 Start', color: '#ff868f', color2: "black", wins: 0, podiums: 0, champs: 0, poles: 0, pic: new URL('@/assets/TeamDrivers/KatherineLegge.png', import.meta.url), flag: new URL('@/assets/Flags/NewZealand.png', import.meta.url)},
        {id: '19', name: "Romain Grosjean", team: 'coyne', statusmobile: 'Fulltime', status: 'Fulltime - 6th year with RLL', color: '#2f589f', color2: "black", wins: 0, podiums: 6, champs: 0, poles: 3, pic: new URL('@/assets/TeamDrivers/RomainGrosjean.png', import.meta.url), flag: new URL('@/assets/Flags/France.png', import.meta.url)},
