...
export default {
  ...
  data () {
    return {
      ...
      currentTeam: {},
      items: [
        {id: 10, name: "Alex Palou", team: 'ganassi', statusmobile: 'Fulltime', status: 'Fulltime - 5th year with CGR', color: '#ffcb01', color2: "#dc1433", wins: 12, podiums: 32, champs: 3, poles: 8, pic: new URL('@/assets/TeamDrivers/AlexPalou.png', import.meta.url), flag: new URL('@/assets/Flags/Spain.png', import.meta.url)},
        ...
        {id: 2, name: "Josef Newgarden", team: 'penske', statusmobile: 'Fulltime', status: 'Fulltime - 9th year with Penske', color: '#b20010', color2: "whitesmoke", wins: 31, podiums: 58, champs: 0, poles: 5, pic: new URL('@/assets/TeamDrivers/JosefNewgarden.png', import.meta.url), flag: new URL('@/assets/Flags/UnitedStates.png', import.meta.url)},
        ...
        {id: 3, name: "Scott McLaughlin", team: 'penske', statusmobile: 'Fulltime', status: 'Fulltime - 5th year with Penske', color: '#f5af05', color2: "black", wins: 7, podiums: 19, champs: 0, poles: 9, pic: new URL('@/assets/TeamDrivers/ScottMcLaughlin.png', import.meta.url), flag: new URL('@/assets/Flags/NewZealand.png', import.meta.url)},
        ...
        {id: 15, name: "Graham Rahal", team: 'rahal', statusmobile: 'Fulltime', status: 'Fulltime - 13th year with RLL', color: '#1e4393', color2: "black", wins: 0, podiums: 0, champs: 0, poles: 0, pic: new URL('@/assets/TeamDrivers/GrahamRahal.png', import.meta.url), flag: new URL('@/assets/Flags/UnitedStates.png', import.meta.url)},
        ...
        {id: 78, name: "Conor Daly", team: 'juncos', statusmobile: 'Fulltime', status: 'Fulltime - Joined Juncos midseason in 2024', color: '#02ff4f', color2: "black", wins: 0, podiums: 2, champs: 0, poles: 1, pic: new URL('@/assets/TeamDrivers/ConorDaly.png', import.meta.url), flag: new URL('@/assets/Flags/UnitedStates.png', import.meta.url)},
        ...
        {id: 33, name: "Ed Carpenter", team: 'na', status: 'Indy Only - 6th year with RLL', color: '#2f589f', color2: "black", wins: 3, podiums: 9, champs: 0, poles: 4, pic: new URL('@/assets/TeamDrivers/EdCarpenter.png', import.meta.url), flag: new URL('@/assets/Flags/NewZealand.png', import.meta.url)},
        {id: 83, name: "Robert Shwartzman", team: 'prema', statusmobile: 'Fulltime', status: 'Fulltime - Ferrari F1 reserve driver in 2024', color: '#ef0000', color2: "black", wins: 0, podiums: 0, champs: 0, poles: 0, pic: new URL('@/assets/TeamDrivers/RobertShwartzman.png', import.meta.url), flag: new URL('@/assets/Flags/NewZealand.png', import.meta.url)},
