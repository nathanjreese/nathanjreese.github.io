  ...
  data () {
    return {
      ...
      items: [
        ...
        {id: 16, name: "David Malukas", original: 'penske', team: 'penske', pic: new URL('@/assets/SillyPhotos/DavidMalukas.jpeg', import.meta.url)},
        ...
        {id: 51, name: "Caio Collet", original: 'foyt', team: 'foyt', pic: new URL('@/assets/SillyPhotos/CaioCollet.jpeg', import.meta.url)},
        ...
        {id: 34, name: "Valtteri Bottas", original: 'na', team: 'na', pic: new URL('@/assets/SillyPhotos/ValtteriBottas.jpeg', import.meta.url)},
