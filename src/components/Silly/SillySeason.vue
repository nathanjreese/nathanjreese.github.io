  ...
  data () {
    return {
      ...
      items: [
        ...
        {id: 9, name: "Santino Ferrucci", original: 'foyt', team: 'foyt', pic: new URL('@/assets/SillyPhotos/SantinoFerrucci.jpeg', import.meta.url)},
        {id: 10, name: "Alexander Rossi", original: 'ecr', team: 'ecr', pic: new URL('@/assets/SillyPhotos/AlexanderRossi.jpeg', import.meta.url)},
        {id: 11, name: "Rinus Veekay", original: 'juncos', team: 'juncos', pic: new URL('@/assets/SillyPhotos/RinusVeeKay.jpeg', import.meta.url)},
        ...
        {id: 14, name: "Felix Rosenqvist", original: 'msr', team: 'msr', pic: new URL('@/assets/SillyPhotos/FelixRosenqvist.jpeg', import.meta.url)},
        ...
        {id: 23, name: "Callum Ilott", original: 'prema', team: 'prema', pic: new URL('@/assets/SillyPhotos/CallumIlott.jpeg', import.meta.url)},
        ...
        {id: 31, name: "Callum Hedge", original: 'na', team: 'na', pic: new URL('@/assets/SillyPhotos/CallumHedge.jpeg', import.meta.url)},
        {id: 32, name: "Lochie Hughes", original: 'na', team: 'na', pic: new URL('@/assets/SillyPhotos/LochieHughes.jpeg', import.meta.url)},
        {id: 33, name: "Hunter McElrea", original: 'fa', team: 'fa', pic: new URL('@/assets/SillyPhotos/HunterMcElrea.jpeg', import.meta.url)},
        {id: 34, name: "Jack Harvey", original: 'na', team: 'na', pic: new URL('@/assets/SillyPhotos/JackHarvey.jpeg', import.meta.url)},
        {id: 35, name: "Yuki Tsunoda", original: 'fa', team: 'fa', pic: new URL('@/assets/SillyPhotos/YukiTsunoda.jpeg', import.meta.url)},
        {id: 36, name: "Pietro Fittipaldi", original: 'fa', team: 'fa', pic: new URL('@/assets/SillyPhotos/PietroFittipaldi.jpeg', import.meta.url)},
        {id: 37, name: "Théo Pourchaire", original: 'fa', team: 'fa', pic: new URL('@/assets/SillyPhotos/TheoPourchaire.jpeg', import.meta.url)},
        {id: 38, name: "Juri Vips", original: 'fa', team: 'fa', pic: new URL('@/assets/SillyPhotos/JuriVips.jpeg', import.meta.url)},
        ...
        {id: 41, name: "Jamie Chadwick", original: 'fa', team: 'fa', pic: new URL('@/assets/SillyPhotos/JamieChadwick.jpeg', import.meta.url)},
