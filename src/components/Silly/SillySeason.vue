  ...
  data () {
    return {
      ...
      items: [
        ...
        {id: 18, name: "Graham Rahal", original: 'fa', team: 'fa', pic: new URL('@/assets/SillyPhotos/GrahamRahal.jpeg', import.meta.url)},
        ...
        {id: 29, name: "Nolan Siegel", original: 'fa', team: 'fa', pic: new URL('@/assets/SillyPhotos/NolanSiegel.jpeg', import.meta.url)},
        ...
        {id: 10, name: "Romain Grosjean", original: 'na', team: 'na', pic: new URL('@/assets/SillyPhotos/RomainGrosjean.jpeg', import.meta.url)},
        {id: 51, name: "Caio Collet", original: 'fa', team: 'fa', pic: new URL('@/assets/SillyPhotos/CaioCollet.jpeg', import.meta.url)},
        {id: 47, name: "Myles Rowe", original: 'fa', team: 'fa', pic: new URL('@/assets/SillyPhotos/MylesRowe.jpeg', import.meta.url)},
        {id: 57, name: "Dennis Hauger", original: 'fa', team: 'fa', pic: new URL('@/assets/SillyPhotos/DennisHauger.jpeg', import.meta.url)},
        ...
        {id: 21, name: "Benjamin Pedersen", original: 'na', team: 'na', pic: new URL('@/assets/SillyPhotos/BenjaminPedersen.jpeg', import.meta.url)}
