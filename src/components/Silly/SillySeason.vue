  ...
  data () {
    return {
      ...
      items: [
        ...
        {id: 15, name: "Linus Lundqvist", original: 'fa', team: 'fa', pic: new URL('@/assets/SillyPhotos/LinusLundqvist.jpeg', import.meta.url)},
        ...
        {id: 20, name: "Marcus Armstrong", original: 'fa', team: 'fa', pic: new URL('@/assets/SillyPhotos/MarcusArmstrong.jpeg', import.meta.url)},
